<?php
    ...
    $perPage = 15;
    $totalCount = Article::countAll();

    $pagination = new Pagination( $page, $perPage, $totalCount );
    $sql = "select article_id, article_topic, postedBy, datePosted from tblarticles where approved = 'yes' order by ";
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="4" align="right">
                            <input type="button" value="Add New" onclick="window.location.href='admin/addarticle.php'" />
                        </td>
                    </tr>
                    </tfoot>
                    <tbody>
                    <?php
                        foreach( $articles as $article ) {
                            ...
                            ?>
                            <tr>
                                <td><?php echo $article->article_topic; ?></td>
                                <td><?php echo $farmer->fullName(); ?></td>
                                <td><?php echo $article->datePosted; ?></td>
                                <td><a href="viewarticle.php?articleid=<?php echo $article->article_id; ?>">View Article</a></td>
                            </tr>
                        <?php
                        }
                    ?>
